...
/*   Updated: 2023/07/10 17:36:51 by rphuyal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pa(t_carrier *pigeons)
{
	...
	if (!pigeons->head_b)
		return ;
	pigeons->head_a = push(pigeons->head_b->value,
			pigeons->head_b->family, pigeons->head_a);
...
void	pb(t_carrier *pigeons)
{
	...
	if (!pigeons->head_a)
		return ;
	pigeons->head_b = push(pigeons->head_a->value,
			pigeons->head_a->family, pigeons->head_b);
